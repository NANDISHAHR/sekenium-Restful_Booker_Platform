...
public class InputFielderrorhadndling extends BaseTest {
	...
	@Test(priority = 3)
	public void InputFilederros() throws Exception {
		//driver.findElement(By.xpath("//*[@id='root']/div/div/div[4]/div/div[2]/div[3]/div[1]/input")).sendKeys("");
		...
		String ExpectedErrorMessage = "size must be between 3 and 18\r\n"
				+ "Firstname should not be blank";
		softAssert.assertEquals(ActualErrorMessage, ExpectedErrorMessage,
				"input Field error message displayed is wrongly");
		Thread.sleep(5000);
		
	}
	
	@Test(priority = 4)
	public void inputerro1() throws Exception {
		
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id='root']/div/div/div[4]/div/div[2]/div[3]/div[1]/input")).sendKeys("we");
		driver.findElement(By.xpath("//*[@id='root']/div[2]/div/div[4]/div/div[2]/div[3]/button[2]")).click();
		Thread.sleep(5000);
	}
