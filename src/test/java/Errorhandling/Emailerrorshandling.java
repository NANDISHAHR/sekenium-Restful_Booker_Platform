...
public class Emailerrorshandling extends BaseTest {
	...
	@Test(priority = 3)
	public void EmailFilederror1() throws Exception {
	...
	@Test(priority = 4)
	public void EmailFilederror2() throws Exception {
		
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id='root']/div/div/div[4]/div/div[2]/div[3]/div[3]/input")).sendKeys("abcd");
		driver.findElement(By.xpath("//*[@id='root']/div[2]/div/div[4]/div/div[2]/div[3]/button[2]")).click();
		Thread.sleep(5000);
	}
}
