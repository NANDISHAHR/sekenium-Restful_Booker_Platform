...
public class lastnameerroshandling extends BaseTest {
	...
	@Test(priority = 3)
	public void LastnameFilederros() throws Exception {
		...
		softAssert.assertEquals(ActualErrorMessage, ExpectedErrorMessage,
				"Lastname Field error message displayed is wrongly");
		Thread.sleep(5000);
	...
	public void inputerro1() throws Exception {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id='root']/div/div/div[4]/div/div[2]/div[3]/div[2]/input")).sendKeys("we");
		driver.findElement(By.xpath("//*[@id='root']/div[2]/div/div[4]/div/div[2]/div[3]/button[2]")).click();
		Thread.sleep(5000);
	}
}
